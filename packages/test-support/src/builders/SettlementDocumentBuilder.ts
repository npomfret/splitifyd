 ...
 * Use this builder for seeding test data in the database.
 * For API responses, use SettlementDTOBuilder instead.
 */
...
/**
 * Builder for creating Settlement documents for database seeding.
 * This builder creates documents WITHOUT the isLocked field (which only exists in DTOs).
 */
export class SettlementDocumentBuilder {
    private settlement: SettlementDocument;
