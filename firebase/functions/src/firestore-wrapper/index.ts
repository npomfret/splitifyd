...
export type { IDocumentReference, IDocumentSnapshot, IFirestoreDatabase, IQuery, IQuerySnapshot, ITransaction, IWriteBatch } from 'ts-firebase-simulator';

export { createFirestoreDatabase, FieldPath, FieldValue, Filter, Timestamp } from 'ts-firebase-simulator';
