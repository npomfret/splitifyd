...
describe('EqualSplitStrategy', () => {
    ...
    describe('calculateSplits', () => {
        ...
        it('should handle decimal amounts correctly', () => {
            ...
            expect(result[1]).toEqual({ userId: 'user2', amount: 5.25 });
        });
        ...
        it('should round amounts to 2 decimal places', () => {
            ...
            expect(result).toHaveLength(3);
            expect(result[0]).toEqual({ userId: 'user1', amount: 3.33 });
            expect(result[1]).toEqual({ userId: 'user2', amount: 3.33 });
            expect(result[2]).toEqual({ userId: 'user3', amount: 3.33 });
        });
