 ...
 *
 * This file provides comprehensive unit test coverage for group validation logic
 ...
 *
 * These tests replace validation scenarios that were testing business logic
 * rather than HTTP-specific behavior.
 */
