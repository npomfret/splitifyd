...
export type { IStorage, IStorageBucket, IStorageFile, StorageFileMetadata, StorageSaveOptions } from '@billsplit-wl/firebase-simulator';
export { createStorage } from '@billsplit-wl/firebase-simulator';
