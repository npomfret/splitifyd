...
export const trackGroupCommentChanges = onDocumentWritten({ document: `${FirestoreCollections.GROUPS}/{groupId}/comments/{commentId}` }, async (event) => {
...
export const trackExpenseCommentChanges = onDocumentWritten({ document: `${FirestoreCollections.EXPENSES}/{expenseId}/comments/{commentId}` }, async (event) => {
