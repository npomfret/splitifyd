import { decodeCursor, encodeCursor, buildPaginatedQuery, CursorData } from '../../src/utils/pagination';
...
describe('Pagination Utilities', () => {
  ...
  describe('buildPaginatedQuery', () => {
    ...
    it('should handle invalid cursor', () => {
      expect(() => buildPaginatedQuery(mockQuery, 'invalid-cursor', 'desc', 10))
        .toThrow(Errors.INVALID_INPUT('Invalid cursor format'));
    });
  });
});