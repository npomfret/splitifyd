...
const TEST_USERS: UserRegistration[] = [
    ...
    {
        email: toEmail('leia.organa@example.com'),
        displayName: toDisplayName('Leia Organa'),
        password: DEFAULT_PASSWORD,
        termsAccepted: true,
        cookiePolicyAccepted: true,
        privacyPolicyAccepted: true,
    ...
    {
        email: toEmail('han.solo@example.com'),
        displayName: toDisplayName('Han Solo'),
        password: DEFAULT_PASSWORD,
        termsAccepted: true,
        cookiePolicyAccepted: true,
        privacyPolicyAccepted: true,
    ...
    {
        email: toEmail('finn@example.com'),
        displayName: toDisplayName('Finn'),
        password: DEFAULT_PASSWORD,
        termsAccepted: true,
        cookiePolicyAccepted: true,
        privacyPolicyAccepted: true,
    ...
    {
        email: toEmail('poe.dameron@example.com'),
        displayName: toDisplayName('Poe Dameron'),
        password: DEFAULT_PASSWORD,
        termsAccepted: true,
        cookiePolicyAccepted: true,
        privacyPolicyAccepted: true,
