...
## Overview
A web-based bill splitting application built with vanilla JavaScript, HTML, and CSS. No frameworks - just clean, maintainable code.
...
1. Start with static HTML/CSS for all main views
...
2. **Groups list on home page**
3. **Add expense form**
4. **Group detail view**
5. **Expense list and filtering**
...
- Consistent color coding (red for debt, green for credit)
