...
describe('GroupsStore', () => {
    ...
    describe('fetchGroups', () => {
        ...
        it('prevents concurrent fetches', async () => {
            ...
            mockApiClient.getGroups.mockImplementation(() => new Promise((resolve) => setTimeout(() => resolve(mockResponse), 100)));
    ...
    describe('createGroup', () => {
        ...
        it('sets error state on creation failure', async () => {
            ...
            await expect(groupsStore.createGroup({ name: 'Test' })).rejects.toThrow('Creation failed');
