...
export function Footer() {
    ...
    return (
        <footer className='bg-surface-muted border-t border-border-default'>
            <div className='max-w-7xl mx-auto px-4 py-8'>
                <div class={`grid grid-cols-1 ${hasFooterLinks ? 'md:grid-cols-2' : ''} gap-8`}>
                    ...
                    <div>
                        ...
                        <p className='help-text'>{t('footer.companyDescription')}</p>
                    </div>

                    {/* Footer Links - dynamically rendered from tenant config */}
                    {hasFooterLinks && (
                        <div>
                            <h3 className='font-semibold text-text-primary mb-3'>{t('footer.linksSection')}</h3>
                                ...
                                {footerLinks.map((link) => (
                                    <li key={link.id}>
                                        <Clickable
                                            ...
                                            className='help-text hover:text-interactive-primary transition-colors'
                ...
                <div className='mt-8 pt-8 border-t border-border-default'>
                    <p className='text-center help-text'>{t('footer.copyright')}</p>
                </div>
            </div>
        </footer>
    );
