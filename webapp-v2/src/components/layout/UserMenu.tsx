    ...
    return (
        <div class='relative z-50' ref={menuRef}>
            ...
            >
                ...
                <svg class={`hidden md:block w-4 h-4 text-text-muted group-hover:text-interactive-primary transition-all duration-200 ${isOpen ? 'rotate-180' : ''}`} fill='none' stroke='currentColor' viewBox='0 0 24 24' aria-hidden='true' focusable='false'>
