        ...
        return (
            <div class="text-center py-8">
                <div class="text-red-600 mb-4">
                    ...
                    <h4 class="text-lg font-medium text-red-800" role="alert" data-testid="groups-load-error-title">Failed to load groups</h4>
                    <p class="text-red-600 mt-1" role="alert" data-testid="groups-load-error-message">{enhancedGroupsStore.error}</p>
                </div>
                <button
                    onClick={() => {
