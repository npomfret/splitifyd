            ...
            <div class='space-y-4'>
                ...
                <div class='grid grid-cols-3 gap-4'>
                    <ColorInput
                        ...
                        label='Ghost'
                        value={formData.interactiveGhostColor}
                        onChange={(v) => update({ interactiveGhostColor: v })}
                        disabled={isSaving}
                    ...
                    <ColorInput
                        ...
                        label='Magnetic'
                        value={formData.interactiveMagneticColor}
                        onChange={(v) => update({ interactiveMagneticColor: v })}
                        disabled={isSaving}
                    ...
                    <ColorInput
                        id='interactive-glow'
                        label='Glow'
                        value={formData.interactiveGlowColor}
                        onChange={(v) => update({ interactiveGlowColor: v })}
                        disabled={isSaving}
