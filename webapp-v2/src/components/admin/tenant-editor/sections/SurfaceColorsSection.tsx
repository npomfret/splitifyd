    ...
    return (
        ...
        >
            ...
            <div class='grid grid-cols-2 gap-4 mt-4'>
                <RgbaColorInput id='surface-overlay' label='Overlay * (rgba)' value={formData.surfaceOverlayColor} onChange={(v) => update({ surfaceOverlayColor: v })} disabled={isSaving} testId='surface-overlay-color-input' />
