...
describe('CategorySuggestionInput', () => {
    ...
    describe('Basic Rendering', () => {
        ...
        it('renders label when provided', () => {
            render(<CategorySuggestionInput {...defaultProps} label="Category" required />);
        ...
        it('displays error message when provided', () => {
            ...
            render(<CategorySuggestionInput {...defaultProps} error={errorMessage} />);
    ...
    describe('Predefined Category Selection', () => {
        ...
        it('calls onChange with category name when suggestion is clicked', async () => {
            ...
            render(<CategorySuggestionInput {...defaultProps} onChange={mockOnChange} />);
    ...
    describe('Edge Cases', () => {
        it('handles empty suggestions array', () => {
            render(<CategorySuggestionInput {...defaultProps} suggestions={[]} />);
        ...
        it('maintains custom input value when provided via props', () => {
            render(<CategorySuggestionInput {...defaultProps} value="Custom Category" />);
