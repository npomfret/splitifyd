...
export function Tooltip({ content, children, placement = 'top', className }: TooltipProps) {
    ...
    const tooltipElement = (
        <span
            ...
            id={tooltipId}
            role='tooltip'
            className={`pointer-events-none fixed z-50 whitespace-nowrap rounded-md border border-border-strong bg-surface-popover px-2.5 py-1.5 text-xs font-medium text-text-primary shadow-md transition-opacity duration-150 backdrop-blur-sm ${
