  ...
  return (
    <Stack spacing="md">
      <div className="flex items-center justify-between">
        ...
        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSplitTypeBadgeColor(expense.splitType)}`}>
            ...
            <div key={split.userId} className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-right">
                  <p className={`font-semibold ${isOwing ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'}`}>
