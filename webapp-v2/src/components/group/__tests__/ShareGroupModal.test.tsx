...
describe('ShareGroupModal', () => {
    ...
    describe('API Integration', () => {
        ...
        it('shows loading spinner while generating link', () => {
            (apiClient.generateShareLink as any).mockImplementation(() => new Promise((resolve) => setTimeout(resolve, 100)));
    ...
    describe('User Interactions', () => {
        ...
        it('closes modal when close button is clicked', async () => {
            ...
            const closeButton = screen.getAllByRole('button').find((button) => button.querySelector('svg path[d*="M6 18L18 6M6 6l12 12"]'));
