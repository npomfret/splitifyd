...
export class TestDataFactory {
  static createSimpleGroup(name?: string): TestGroup {
    return new GroupBuilder()
      .withName(name || 'Simple Test Group')
      .withDescription('A simple group for testing')
      .build();
  }


  static createSimpleExpense(amount: number = 100): TestExpense {
  ...
  static createComplexSplitExpense(): TestExpense {
    return new ExpenseBuilder()
      .withDescription('Group dinner with different meal costs')
      .withAmount(150.00)
      .withCategory('food')
      .withExactSplit([
        { userId: 'user1', amount: 45.50 },
        { userId: 'user2', amount: 32.00 },
        { userId: 'user3', amount: 72.50 }
      ])
      .build();
  }
