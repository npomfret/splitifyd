...
authenticatedPageTest.describe('Authentication Security', () => {
    ...
    authenticatedPageTest('should protect group pages from unauthorized access', async ({ 
        authenticatedPage, 
        dashboardPage, 
...
multiUserTest.describe('Multi-User Security', () => {
    multiUserTest('should prevent users from accessing other users groups', async ({ 
        authenticatedPage, 
        secondUser,
        dashboardPage,
        createGroupModalPage 
