...
function renderAddExpensePage(): void {
    ...
    const pageDiv = createElementSafe('div', { className: 'add-expense-page' });
    
    // Warning banner
    const warningBanner = createElementSafe('div', { 
        id: 'warningBanner', 
        className: 'warning-banner hidden' 
    });
    pageDiv.appendChild(warningBanner);
    
    // Main container
    const mainContainer = createElementSafe('div', { className: 'group-detail-container' });
    
    // Header section with modern styling
    const headerSection = createElementSafe('div', { className: 'add-expense-header' });
    
    // Navigation
    const nav = createElementSafe('div', { className: 'add-expense-nav' });
    const backButton = createButton({
        html: '<i class="fas fa-arrow-left"></i> <span>Back</span>',
        variant: 'secondary',
    ...
    // Form container
    const formContainer = createElementSafe('div', { 
        className: 'add-expense-form-container',
        id: 'formContainer'
    });
    
    mainContainer.appendChild(formContainer);
    pageDiv.appendChild(mainContainer);
    appRoot.appendChild(pageDiv);
}
